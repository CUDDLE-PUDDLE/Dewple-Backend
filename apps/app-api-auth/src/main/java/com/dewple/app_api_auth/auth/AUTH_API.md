...
회원가입 플로우의 후속 단계 API는 User API에서 제공됩니다.

- **아이디 중복 확인**: `GET /users/check-userid` → [USER_API.md 6번](../api/user/USER_API.md#6-아이디-중복-확인)
- **프로필 설정 (2단계)**: `PATCH /users/me/profile` → [USER_API.md 7번](../api/user/USER_API.md#7-회원가입-시-프로필-설정)
