...
public enum RecruitmentErrorCode implements ErrorCode {
    ...
    FORM_COMPONENT_REMOVAL_NOT_ALLOWED(5109, HttpStatus.BAD_REQUEST, "지원서 양식에서 기존 컴포넌트를 삭제할 수 없습니다."),
    ...
    APPLICATION_NOT_WITHDRAWABLE(5203, HttpStatus.BAD_REQUEST, "합격 또는 불합격 상태의 지원서는 철회할 수 없습니다."),
    ...
    GUEST_APPLICATION_ALREADY_SUBMITTED(5209, HttpStatus.CONFLICT, "해당 전화번호로 이미 제출된 지원서가 존재합니다."),
    GUEST_APPLICATION_NOT_FOUND(5210, HttpStatus.NOT_FOUND, "해당 전화번호로 제출된 지원서를 찾을 수 없습니다."),
